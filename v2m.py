...
def create_inline_keyboard():
    ...
    button = InlineKeyboardButton(text="OWNER", url="https://t.me/serverfreezbgmibadsah")
    keyboard.add(button)
    return keyboard
...
def attack_command(message):
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*You are not approved to use this bot. \nPlease contact @serverfreezbgmibadsah*", parse_mode='Markdown', reply_markup=create_inline_keyboard())
            return
...
def owner_command(message):
    bot.send_message(message.chat.id, "*Owner - @serverfreezbgmibadsah*", parse_mode='Markdown', reply_markup=create_inline_keyboard())
...
def canary_command(message):
    ...
    button1 = InlineKeyboardButton(
        ...
        url="https://t.me/serverfreezbgmibadsah")
